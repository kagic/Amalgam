...
import mod.akrivus.amalgam.entity.ai.EntityAIPickUpLoot;
...
public class EntityHuman extends EntityCreature implements IInventoryChangedListener, INpc {
	...
	public void openGUI(EntityPlayer player) {
        if (!this.world.isRemote && this.isBackpacked()) {
        	String name = new TextComponentTranslation("command.amalgam." + this.getRealName().toLowerCase() + ".name").getUnformattedComponentText();
