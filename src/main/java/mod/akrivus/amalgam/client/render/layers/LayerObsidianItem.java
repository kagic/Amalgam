...
public class LayerObsidianItem implements LayerRenderer<EntityLivingBase> {
	protected final RenderGemBase livingEntityRenderer;
	
	public LayerObsidianItem(RenderGemBase renderPearl) {
	...
	private void renderHeldItem(EntityLivingBase entity, ItemStack stack, ItemCameraTransforms.TransformType camera, EnumHandSide handSide) {
		if (!stack.isEmpty()) {
			...
			GlStateManager.translate((float)(flag ? -1 : 1) / 24.0F, 0.125F, -0.75F);
