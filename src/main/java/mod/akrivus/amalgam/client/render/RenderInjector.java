...
import mod.akrivus.amalgam.client.render.layers.LayerInjectorGlow;
...
public class RenderInjector extends RenderLiving<EntityInjector> {
	public RenderInjector() {
		...
		this.addLayer(new LayerInjectorGlow(this));
	}
	@Override
	protected ResourceLocation getEntityTexture(EntityInjector entity) {
		return new ResourceLocation("amalgam:textures/entities/injector/tier_" + entity.getLevel() + ".png");
	}
}
