...
public class LayerPyritePlacement implements LayerRenderer<EntityGem> {
	private final RenderLivingBase<?> gemRenderer;
	private final ModelBase gemModel;
	public LayerPyritePlacement(RenderLivingBase<?> gemRendererIn) {
	...
	public ResourceLocation getTexture(EntityGem gem, String placement) {
		return new ResourceLocation("amalgam:textures/entities/pyrite/gems/" + placement + ".png");
	}
