...
public class LayerNacreColor3 implements LayerRenderer<EntityNacre> {
	private final RenderNacre gemRenderer;
	private final ModelBase gemModel;
	private float offset;
	private String name;
	
	public LayerNacreColor3(RenderNacre gemRenderer) {
		this(gemRenderer, 0F);
	}

	public LayerNacreColor3(RenderNacre gemRenderer, float offset) {
		this(gemRenderer, offset, null);
	}
	
	public LayerNacreColor3(RenderNacre gemRenderer, float offset, String name) {
	...
	public void doRenderLayer(EntityNacre gem, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		...
		int skin = gem.getLayerColor(gem.getColor3());
	...
	public ResourceLocation getTexture(EntityNacre gem) {
		return new ResourceLocation("amalgam:textures/entities/nacre/color_3.png");
	}
